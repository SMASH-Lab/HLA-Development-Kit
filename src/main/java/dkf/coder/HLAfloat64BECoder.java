...
public class HLAfloat64BECoder implements Coder<Double>{

	private HLAfloat64BE coder = null;
	private EncoderFactory factory = null;

	public HLAfloat64BECoder() throws RTIinternalError {
		this.factory = RtiFactoryFactory.getRtiFactory().getEncoderFactory();
		this.coder = factory.createHLAfloat64BE();
	}
